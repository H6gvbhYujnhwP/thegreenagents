...
import { ArrowLeft, Share2, BarChart3, Target, Zap, CheckCircle, ArrowRight, Play } from 'lucide-react'
import { Button } from '../components/ui/button'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '../components/ui/card'
import { Link } from 'react-router-dom'
import tgaLogo from '../assets/TheGreenAgentsLogoWebsite.png'
import marketingHero from '../assets/marketing-automation-hero.png'
...
const MarketingAutomationPage = () => {
  ...
  const facts = [
    "Marketing automation can increase qualified leads by 451% and sales productivity by 14.5%!",
    "Companies using marketing automation see 53% higher conversion rates from initial response to MQL!",
    "Automated social media posting increases engagement rates by up to 67%!",
    "AI-powered content creation can produce marketing copy 10x faster than humans!",
    "Businesses using marketing automation generate 2x more leads at 33% lower cost!"
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                Marketing Automation <span className="text-green-400">Agent</span>
              </h1>
              <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                Complete marketing campaigns that run themselves. From social media management to ad optimization, our AI agent handles your entire marketing pipeline with precision and intelligence.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">Comprehensive Marketing Automation</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Our Marketing Automation Agent handles every aspect of your marketing strategy with intelligent automation.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Automated posting, engagement tracking, and content optimization across all major social platforms."
              },
              {
                icon: Target,
                title: "Ad Campaign Optimization",
                description: "AI-powered ad creation, targeting, and budget optimization for maximum ROI across all channels."
              },
              {
                icon: Zap,
                title: "Content Creation",
                description: "Intelligent content generation for blogs, social posts, ads, and email campaigns tailored to your brand."
              },
              {
                icon: BarChart3,
      ...
      <section id="contact-form" className="py-20 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Ready to Automate Your Marketing?</h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Schedule your free consultation and discover how our Marketing Automation Agent can transform your campaigns.
            </p>
          </motion.div>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="What marketing challenges are you facing? What campaigns would you like to automate?"
                    ></textarea>
                  </div>
                  ...
                  >
                    Get My Free Marketing Automation Consultation
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                  
                  <p className="text-sm text-white/70 text-center">
                    No commitment required. We'll show you exactly how marketing automation can transform your campaigns.
                  </p>
                </form>
              </motion.div>
            ) : (
