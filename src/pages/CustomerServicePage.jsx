    ...
    <div className="bg-white">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-teal-600 to-teal-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6">Ready to Elevate Your Customer Service?</h2>
          <p className="text-lg sm:text-xl text-teal-100 mb-6 sm:mb-8 lg:mb-10">Join hundreds of UK SMEs delivering exceptional support with AI automation.</p>
