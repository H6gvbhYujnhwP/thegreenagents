    ...
    <div className="bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-teal-600 to-teal-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Make Data-Driven Decisions?</h2>
          <p className="text-xl text-teal-100 mb-10">Join hundreds of UK SMEs using AI to turn data into competitive advantage.</p>
